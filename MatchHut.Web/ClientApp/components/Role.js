...
import { required, SimpleForm, List, Datagrid, TextField, RichTextField, DateField, EditButton, Edit, Create, TextInput, LongTextInput } from 'react-admin';
...
export const RoleList = (props) => (
    <List {...props} title="Role" filter={{ status: 'A' }}>
        <Datagrid>
            ...
            <RichTextField source="description" label="Description" sortable={false} />

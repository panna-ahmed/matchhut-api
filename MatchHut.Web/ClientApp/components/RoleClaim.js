...
import {
    required, SimpleForm, List, Datagrid, TextInput,
    TextField, DateField, EditButton, Edit, Create, SelectInput, ReferenceInput,
    TopToolbar, CreateButton, RefreshButton, useListContext
} from 'react-admin';
...
export const RoleClaimList = (props) => (
    <List {...props} empty={<Empty />} title="Role Claim" actions={<RoleClaimActions />} filter={{ status: 'A' }}>
        <Datagrid>
...
export const RoleClaimEdit = (props) => (
    <Edit title={<RoleClaimTitle />} {...props}>
        <SimpleForm>
            ...
            <ReferenceInput label="Claim" source="claimValue" reference="claims" validate={required()}>
...
export const RoleClaimCreate = (props) => (
    <Create title="Create an Role Claim" {...props}>
        <SimpleForm>
            <ReferenceInput label="Role Name" source="roleId" reference="roles" allowEmpty>
                <SelectInput optionText="roleName" />
            </ReferenceInput>
            <ReferenceInput label="Claim" source="claimValue" reference="claims" validate={required()}>
                <SelectInput optionText="value" />
...
export const RoleClaimDelete = (props) => <Delete {...props} title={<RoleClaimTitle />} />;
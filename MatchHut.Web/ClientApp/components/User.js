...
import { required, SimpleForm, List, Datagrid, TextField, DateField, EditButton, Edit, Create, TextInput } from 'react-admin';
...
export const UserEdit = (props) => (
    <Edit title={<UserTitle />} {...props}>
        <SimpleForm>
            ...
            <TextInput source="email" label="Email Address" type="email" validate={required()} />
